...
tree.o: tree.c tree.h
	gcc -c tree.c $(FLAGI)
utilities.o: utilites.c utilities.h
	gcc -c utilities.c $(FLAGI)
main.o: main.c
	gcc -c main.c $(FLAGI)
main: tree.o self_sorting_list.o double_ended_list.o main.o
	gcc -o main double_ended_list.o self_sorting_list.o tree.o utilities.o main.o $(FLAGI)
clean:
